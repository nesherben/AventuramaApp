...
?>
<link rel="stylesheet" href="<?php echo baseUrl ?>locals/css/home.css">
    ...
    <div class="row" style="min-height: 0">
      ...
      <h2 class="head-sticky border-bottom shadow-sm"><?php echo $key?></h2>
        ...
        <div class="col-auto mb-3" style="width: 360px; height:350px">
          <a href="<?php echo baseUrl ?>inscripcion?elem=<?php echo $elem['codigo']?>" class="hoverable">
            <div class="card shadow-sm">
              <img width="360px" height="200px" src="<?php echo ($elem['imagen'] != "" ? $elem['imagen'] : "".baseUrl."logopie.png")?>" class="card-img-top" alt="...">
